...
// Local change: upstream read "data/titanic.tsv" relative to the working
// directory, from a data/ folder outside src/ that is not vendored. This uses
// the identical fixture already present in testSupport/.
var titanic = fs.readFileSync(
  path.join(__dirname, "../testSupport/titanic.tsv"),
  "utf8"
)
