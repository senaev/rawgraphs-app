...
const dateTokensMap = {
  ...
  mm: "%M",
  ss: "%S",
  // Local addition. Order matters: SSS is listed after ss so that the "ss"
  // pattern cannot consume part of it.
  SSS: "%L",
  // Local addition. %Z reads the zone, so timeParse returns the correct
  // instant and also accepts "+02:00" / "-0700". A literal "Z" would be
  // parsed as local time and shift every value by the viewer's offset.
  Z: "%Z",
}
...
const formatsLabels = [
  ...
  "YYYY-MM-DD HH:mm:ss",
  "YYYY-MM-DDTHH:mm:ss",
  // Local addition: ISO 8601 with milliseconds and zone.
